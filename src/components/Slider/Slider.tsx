...
export const Slider = () => {
  return (
    <section className="flex w-full h-[377px]">
      <div className="w-full max-h-full bg-no-repeat bg-fixed bg-cover bg-center bg-[url(/public/assets/images/sliderbg.jpg)]">
